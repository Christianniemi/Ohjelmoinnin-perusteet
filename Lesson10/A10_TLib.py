...
def bubbleSort(PArr: list[int], PLow: int = None, PHigh: int = None, PAsc: bool = True) -> None:
    if PLow == None: PLow = 0
    ...
    if PLow < PHigh:
        ...
        bubbleSort(PArr, PLow, PivotIndex - 1, PAsc)
        bubbleSort(PArr, PivotIndex + 1, PHigh, PAsc)
    return None
